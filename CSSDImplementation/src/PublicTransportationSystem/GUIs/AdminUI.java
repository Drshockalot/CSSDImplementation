    ...
    private void initAddEditView() {
        ...
        if (row == -1) {
            try {
                ...
                txt_adminUserAddEditForename.setText("");
                txt_adminUserAddEditSurname.setText("");
                txt_adminUserAddEditUsername.setText("");
                txt_adminUserAddEditEmail.setText("");
                txt_adminUserAddEditPassword.setText("");
            } catch (Throwable ex) {
                Logger.getLogger(AdminUI.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
